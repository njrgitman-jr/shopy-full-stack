  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-lg font-bold">{t("myDeliveryOrders")}</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        ...
        >
          ...
          <option value="highAmount">{t("highestAmount")}</option>
          <option value="lowAmount">{t("lowestAmount")}</option>
        </select>
      </div>
        ...
        {filteredOrders.map((o, idx) => (
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm mb-3">
              ...
              <p>
                <b>{t("amount")}:</b> ${Number(o.totalAmt).toFixed(3)}
              </p>
            </div>

            <p className="text-sm">
              <b>{t("status")}:</b> {o.orderStatus}
            </p>

            <p className="mt-2 font-semibold">{t("deliveryStatus")}:</p>
            <select
            ...
            <h3 className="mt-3 font-semibold">{t("items")}:</h3>
                ...
                >
                  <div className="mb-2">
                    ...
                    <p className="text-gray-700 font-semibold">
                      {t("price")}: ${item.product_details?.price || 0}
                    </p>
                  </div>
